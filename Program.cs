...
options.UseSqlServer(builder.Configuration.GetConnectionString("Pavel_Eduard_Cristian_Lab2Context") ?? throw new InvalidOperationException("Connectionstring 'Pavel_Eduard_Cristian_Lab2Context' not found.")));
